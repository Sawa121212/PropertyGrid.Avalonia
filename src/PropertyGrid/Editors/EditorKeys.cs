namespace PropertyGrid.Editors
{
    ...
    public static class EditorKeys
    {
        ...
        private static readonly string _ObservableCollectionEditorKey = "ObservableCollectionEditor";
        ...
        /// <summary>
        /// Возвращает по умолчанию ObservableCollectionEditorKey
        /// </summary>
        public static string ObservableCollectionEditorKey
        {
            get { return _ObservableCollectionEditorKey; }
        }
    }
}