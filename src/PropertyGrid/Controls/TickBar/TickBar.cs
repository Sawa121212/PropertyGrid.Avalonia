...
using PropertyGrid.Controls.Slider;

namespace PropertyGrid.Controls.TickBar
{
    ...
    public class TickBar : Control
    {
        ...
        /// <summary>
        /// The IsDirectionReversed property Определяет свойство direction of value incrementation.
        ...
        private void UpdateProperties(Track track)
        {
            ...
            if (track.Thumb != null)
            {
                if (parent.Orientation == global::Avalonia.Layout.Orientation.Horizontal)
                {
