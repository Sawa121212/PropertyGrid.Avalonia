...
namespace PropertyGrid.Controls.Helpers
{
    public static class Extensions
    {
        ...
        public static IEnumerable<IControl> GetChildObjects(this IControl parent, bool forceUsingTheVisualTreeHelper = false)
        {
            ...
            else
            {
                ...
                foreach (var item in global::Avalonia.VisualTree.VisualExtensions.GetVisualChildren(visual))
                {
                    IControl avalonia = item as IControl;
                    if (avalonia != null)
                        yield return item as IControl;
        ...
        {
            IVisual parent = global::Avalonia.VisualTree.VisualExtensions.GetVisualParent(child);
            while (parent != null)
            {
                yield return parent;
                parent = global::Avalonia.VisualTree.VisualExtensions.GetVisualParent(parent);
            }
        }
        ...
        {
            return (Classes)element.GetValue(ClassesProperty);
        }
