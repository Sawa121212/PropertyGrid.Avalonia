...
namespace PropertyGrid.Design
{
    ...
    public class ExtendedPropertyEditorTab : TabbedLayoutItem
    {
        ...
        /// <summary>
        /// Initializes the <see cref="ExtendedPropertyEditorTab"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendedPropertyEditorTab"/>.
        /// </summary>
        ...
        protected virtual object CreateContent(PropertyItem propertyItem)
        {
            ...
            content.SetValue(DataContextProperty, propertyItem);
